                ...
                .setMethodCallHandler(
                        (call, result) -> {
                            if(call.method.equals(PrinterStrings.connectCommand)){
                                ...
                                String widthUsed = call.argument(PrinterStrings.widthUsedArg);
                                if(imgPath!=null&&widthUsed!=null){
                                    PrinterManager.printImg(imgPath,widthUsed);
                                }
                            }
                        }
                );
...
class PrinterManager {
    ...
    static void printImg(String imgPath,String widthUsed){
        ...
        new Thread(() -> {
            ...
            if(Integer.parseInt(widthUsed) ==  PrintersWidth.mm_3inch){
                bitmapSetting.setBimtapLimitWidth(PrintersWidth.mm_3inch * 8);
            }else if(Integer.parseInt(widthUsed) ==  PrintersWidth.mm_2inch){
                bitmapSetting.setBimtapLimitWidth(PrintersWidth.mm_2inch * 8);
            }
